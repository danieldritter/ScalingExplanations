...
# srun python model_training_scripts/train_models.py with 'run_name="dn_t5_tiny_enc/eraser_esnli/avg-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python model_training_scripts/train_models.py with 'run_name="dn_t5_mini_enc/eraser_esnli/avg-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python model_training_scripts/train_models.py with 'run_name="dn_t5_small_enc/eraser_esnli/avg-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python model_training_scripts/train_models.py with 'run_name="dn_t5_base_enc/eraser_esnli/avg-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python model_training_scripts/train_models.py with 'run_name="dn_t5_tiny_enc/spurious_sst/avg-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python model_training_scripts/train_models.py with 'run_name="dn_t5_mini_enc/spurious_sst/avg-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python model_training_scripts/train_models.py with 'run_name="dn_t5_small_enc/spurious_sst/avg-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python model_training_scripts/train_models.py with 'run_name="dn_t5_base_enc/spurious_sst/avg-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
