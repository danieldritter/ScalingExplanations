...
srun python train_models.py with 'run_name="t5_text_to_text/mnli/finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets' 'disable_tqdm=True'