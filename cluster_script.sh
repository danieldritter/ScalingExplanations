...
srun python train_models.py with 'run_name="bert_base_uncased/sst/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True'
