...
# srun python train_models.py with 'run_name="dn_t5_tiny_enc/eraser_cose/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python train_models.py with 'run_name="dn_t5_mini_enc/eraser_cose/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python train_models.py with 'run_name="dn_t5_small_enc/eraser_cose/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python train_models.py with 'run_name="dn_t5_base_enc/eraser_cose/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python train_models.py with 'run_name="bert_base_uncased/eraser_cose/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
...
# srun python train_models.py with 'run_name="t5_base_enc/eraser_cose/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
# srun python train_models.py with 'run_name="roberta_base/eraser_cose/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'
...
srun python train_models.py with 'run_name="roberta_base/eraser_esnli/cls-finetune"' 'data_cache_dir="/scratch-ssd/ms21ddr/data/hf_language_datasets"' 'disable_tqdm=True' 'output_dir="/scratch-ssd/ms21ddr/model_outputs"'